...
**[Documentation on Pages](https://treq-quantum.github.io/oaq-specification/)**

## Getting Started

The recommended reading order for new users:

1. **[Examples](./oaq_specification/examples/)** — worked examples from simple single-pulse jobs through to multiplexed readout and active reset
2. **[UML class diagram](./oaq_specification/uml/Job/)** — the formal definition of the specification as a class hierarchy. Start here to understand the shape of the ASG
3. **[Reference documentation](./oaq_specification/docs/)** — descriptions of each object, field, and serialization format

## Documentation

| Section | Description |
|---------|-------------|
| [UML / Formal Definition](./oaq_specification/uml/) | Class diagrams defining the full ASG structure for Job and Results |
| [Reference Docs](./oaq_specification/docs/) | Reference and descriptions for all elements of the specification |
| [Examples](./oaq_specification/examples/) | Annotated example jobs covering simple cases and common quantum workflows |
...
Contributions are welcome — see [CONTRIBUTING.md](./CONTRIBUTING.md) for guidelines on reporting issues, proposing spec changes, and adding examples.
